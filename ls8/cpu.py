...
class CPU:
    ...
    def __init__(self):
        ...
        # Initialize halt at false. CPU does not start halted
        self.halt = False
...
#         ]
    ...
    def PRN(self):
        """
        Prints numeric values stored at register's address
        """
    ...
    def IRET(self):
        ...
        for i in range(7):
            ...
            # The FL register is popped off the stacj.
    ...
    def JNE(self):
        """
        If E flag is clear (flase, 0), jump to the address stored in the given register
        """
        bit_0 = (self.fl & 2 ** 0) >> 0
